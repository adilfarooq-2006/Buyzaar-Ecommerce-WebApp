...
const page = () => {
  return (
    <div className='mt-3 mx-20 rounded-md flex justify-center items-center flex-col gap-3 p-4 h-auto'>
      <h1 className='text-6xl text-blue-500 font-bold mt-10'>You are not authorized</h1>
      <p className='p-2 text-2xl'>You are not authorized to access this admin console</p>
      <Link href="/">
